...
class Lexeme(Base):
    ...
    __table_args__ = (UniqueConstraint("target_language", "normalized", name="uq_lexeme_lang_norm"),)
...
class UserLexeme(Base):
    ...
    __table_args__ = (UniqueConstraint("user_id", "lexeme_id", name="uq_user_lexeme"),)
...
class LessonLexeme(Base):
    ...
    __table_args__ = (UniqueConstraint("generated_lesson_id", "lexeme_id", name="uq_lesson_lexeme"),)
