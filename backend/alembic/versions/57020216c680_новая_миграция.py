...
def upgrade() -> None:
    ...
    sa.Column('id', app.features.common.db.GUID(), nullable=False),
    ...
    sa.Column('owner_user_id', app.features.common.db.GUID(), nullable=True),
    ...
    sa.Column('selected_theme_id', app.features.common.db.GUID(), nullable=True),
    ...
    sa.Column('id', app.features.common.db.GUID(), nullable=False),
    sa.Column('owner_user_id', app.features.common.db.GUID(), nullable=False),
    sa.Column('slug', sa.String(), nullable=False),
    sa.Column('display_name', sa.String(), nullable=False),
    sa.Column('description', sa.String(), nullable=False),
    ...
    sa.Column('chat_theme_id', app.features.common.db.GUID(), nullable=True),
    sa.Column('is_public', sa.Boolean(), nullable=False),
    ...
    sa.Column('id', app.features.common.db.GUID(), nullable=False),
    sa.Column('user_id', app.features.common.db.GUID(), nullable=False),
    ...
    sa.Column('replaced_by_id', app.features.common.db.GUID(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    ...
    sa.Column('id', app.features.common.db.GUID(), nullable=False),
    sa.Column('user_id', app.features.common.db.GUID(), nullable=False),
    sa.Column('achievement_id', app.features.common.db.GUID(), nullable=False),
    ...
    sa.Column('id', app.features.common.db.GUID(), nullable=False),
    sa.Column('owner_user_id', app.features.common.db.GUID(), nullable=False),
    sa.Column('character_id', app.features.common.db.GUID(), nullable=True),
    sa.Column('room_id', app.features.common.db.GUID(), nullable=True),
    sa.Column('title', sa.String(), nullable=False),
    ...
    sa.Column('id', app.features.common.db.GUID(), nullable=False),
    sa.Column('author_user_id', app.features.common.db.GUID(), nullable=False),
    sa.Column('character_id', app.features.common.db.GUID(), nullable=True),
    sa.Column('title', sa.String(), nullable=False),
    ...
    sa.Column('id', app.features.common.db.GUID(), nullable=False),
    sa.Column('room_id', app.features.common.db.GUID(), nullable=False),
    sa.Column('character_id', app.features.common.db.GUID(), nullable=False),
    ...
    sa.Column('id', app.features.common.db.GUID(), nullable=False),
    sa.Column('session_id', app.features.common.db.GUID(), nullable=False),
    ...
    sa.Column('character_id', app.features.common.db.GUID(), nullable=True),
    sa.Column('room_id', app.features.common.db.GUID(), nullable=True),
    sa.Column('session_id', app.features.common.db.GUID(), nullable=True),
    sa.Column('title', sa.String(), nullable=False),
    sa.Column('content', sa.Text(), nullable=False),
    sa.Column('is_pinned', sa.Boolean(), nullable=False),
    ...
    sa.Column('id', app.features.common.db.GUID(), nullable=False),
    sa.Column('post_id', app.features.common.db.GUID(), nullable=False),
    sa.Column('author_user_id', app.features.common.db.GUID(), nullable=False),
    sa.Column('parent_id', app.features.common.db.GUID(), nullable=True),
    sa.Column('content', sa.Text(), nullable=False),
    sa.Column('is_deleted', sa.Boolean(), nullable=False),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    ...
    sa.Column('owner_user_id', app.features.common.db.GUID(), nullable=False),
    sa.Column('session_id', app.features.common.db.GUID(), nullable=True),
    sa.Column('turn_id', app.features.common.db.GUID(), nullable=True),
